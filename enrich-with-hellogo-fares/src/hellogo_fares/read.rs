...
struct HellogoTicket(Ticket);
impl TryFrom<&Element> for HellogoTicket {
...
impl TryFrom<(String, Decimal, String, (Date, Date))> for HellogoTicketPrice {
    ...
    fn try_from(
        ...
        Ok(HellogoTicketPrice(ticket_price))
    }
}
...
impl From<(String, String)> for HellogoTicketUsePerimeter {
    fn from((ticket_use_id, line_id): (String, String)) -> Self {
        let ticket_use_perimeter = TicketUsePerimeter {
            ticket_use_id,
            object_type: ObjectType::Line,
            object_id: line_id,
            perimeter_action: PerimeterAction::Included,
        };
        HellogoTicketUsePerimeter(ticket_use_perimeter)
    }
}
...
mod tests {
    ...
    mod prefix {
        ...
        use transit_model::objects::Contributor;
