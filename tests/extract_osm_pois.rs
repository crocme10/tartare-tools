...
fn test_export_pois() {
    test_in_tmp_dir(|path| {
        let osm_pbf = "./fixtures/pois/input/osm_fixture.osm.pbf";
        let pois_config = "./fixtures/pois/input/pois_config.json";
        ...
        compare_output_dir_with_expected(
            &path,
            vec!["pois.txt", "poi_properties.txt", "poi_types.txt"],
            "./fixtures/pois/output",
        );
    });
}
